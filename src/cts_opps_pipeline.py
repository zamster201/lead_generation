...
from sam_client import set_api_key
...
def main():
    ...
    ap.add_argument("--sam-api-key",dest="sam_api_key",help="Explicit SAM API key to use (overrides environment)",default=None)
    ...
    write_runlog(args.export_dir, "md", runlog_data)
